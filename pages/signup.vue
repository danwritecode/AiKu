    ...
    <div class="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          ...
          <h2 class="mt-6 text-3xl font-bold tracking-tight dark:text-zinc-100 text-zinc-900">Sign up and start creating</h2>
        </div>
          ...
          <div>
            ...
            <div class="relative mt-6">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="dark:bg-zinc-800 bg-zinc-100 px-2 dark:text-zinc-300 text-zinc-500">Or sign up with</span>
              </div>
            </div>
          </div>
