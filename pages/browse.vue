<template>
  <div class="flex items-center justify-center h-screen bg-zinc-100 dark:bg-zinc-800">
    <main class="px-4">
      ...
      <NuxtLink to="/create" class="w-full mt-5 inline-flex justify-center items-center rounded-md border border-transparent bg-violet-600 px-8 py-3 text-base font-medium text-white shadow-sm hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 transition-hover-300">
