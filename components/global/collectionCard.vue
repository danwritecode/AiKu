    ...
    <div>
      <div class="-mt-px flex divide-x dark:divide-zinc-700 divide-zinc-200">
        <div class="flex w-0 flex-1">
          <NuxtLink :to="'/collections/' + collection.id" class="group relative -mr-px inline-flex w-0 flex-1 items-center justify-center rounded-bl-lg border border-transparent py-4 text-sm font-medium text-zinc-700 hover:text-zinc-500 dark:hover:text-zinc-100 transition-hover-300">
